...
const Work = ({ data }: { data: IPortfolio }) => {
  ...
  return (
    <div className="flex max-sm:flex-col from-top-slide max-sm:pb-5 bg-background p-2 rounded-xl group hover:shadow hover:shadow-primary duration-150">
      ...
      <div className="sm:w-1/2 ps-4 pt-4 ">
        <div className="flex gap-2 place-items-center">
          {data.logo && (
            <Image
              src={data.images[0]}
              className="duration-200 w-8 rounded-full object-cover"
              alt="Insafe"
            />
          )}
